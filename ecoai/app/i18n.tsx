...
const translations: Record<LangCode, Record<string, string>> = {
  en: {
    ...
    proof_code: "Helps you code & debug just as well — the greenest option available",
    proof_create: "Sparks creative ideas just as well — at a fraction of the energy",
    co2_saved: "🌱 Saved 2.9 mg CO₂ vs ChatGPT",
  },
  fr: {
    ...
    proof_code: "Aide à coder et déboguer aussi bien — l'option la plus verte",
    proof_create: "Génère des idées créatives tout aussi bien — à une fraction de l'énergie",
    co2_saved: "🌱 2,9 mg CO₂ économisés vs ChatGPT",
  },
  es: {
    ...
    activity_code: "Ayuda con código",
    ...
    proof_code: "Ayuda a codificar y depurar igual de bien — la opción más verde",
    proof_create: "Genera ideas creativas igual de bien — con mucha menos energía",
    co2_saved: "🌱 Ahorraste 2,9 mg CO₂ vs ChatGPT",
  },
  de: {
    ...
    proof_code: "Hilft genauso gut beim Coden & Debuggen — die grünste Option",
    proof_create: "Generiert genauso kreative Ideen — bei einem Bruchteil der Energie",
    co2_saved: "🌱 2,9 mg CO₂ gespart vs. ChatGPT",
  },
  it: {
  ...
  pt: {
    ...
    activity_summarize: "Resumir",
    activity_code: "Ajuda com código",
    ...
    co2_saved: "🌱 Economizou 2,9 mg CO₂ vs ChatGPT",
  },
  zh: {
    nav_leaderboard: "排行榜",
    nav_chat: "聊天",
